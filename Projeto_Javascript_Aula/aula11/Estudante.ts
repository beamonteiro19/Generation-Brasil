import { InterfaceEscritor } from "./InterfaceEscritor";
import { InterfacePintor } from "./InterfacePintor";
import { Pessoa } from "./Pessoa";

export class Estudante extends Pessoa implements InterfaceEscritor, InterfacePintor {
