  //abre e fecha diamante informa que sesse array vai guardar um determinado tipo de dado
// notas é do tipo arry de numbers e para inicializar eu dou um new const notas: number =8,9,10
...
for(let nota of notas){  //nota representa cada item dentro da collection notas
    //nquanto tiver itens dentro de n ontransitioncancel, ele vai percorrer o laço
